...
class FavPostRoutes {
  ...
  public routes(): Router {
    ...
    this.router.delete('/favpost/:userId/:postId', authMiddleware.checkAuthentication, Delete.prototype.post);

    return this.router;
  }
}

export const favpostRoutes: FavPostRoutes = new FavPostRoutes();
